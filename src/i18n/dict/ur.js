...
export const DICTIONARY = {
    ...
    "theme.light": "روشن",
    "theme.dark": "گہرا",
    "donate.eyebrow": "کرپٹو میں عطیہ دیں",
    "donate.title": "SecureBit کو خودمختار رکھیں",
    "donate.description": "ہر عطیہ ڈیولپمنٹ اور سیکیورٹی آڈٹ پر خرچ ہوتا ہے۔",
    "donate.copy": "کاپی کریں",
    "donate.copied": "کاپی ہو گیا",
    "donate.net.usdt": "USDT · Tron (TRC-20)",
    "donate.net.btc": "Bitcoin نیٹ ورک",
    "donate.net.eth": "Ethereum مین نیٹ",
    "donate.warn.usdt": "صرف Tron (TRC-20) پر USDT بھیجیں۔",
    "donate.warn.btc": "صرف Bitcoin نیٹ ورک پر BTC بھیجیں۔",
    "donate.warn.eth": "صرف Ethereum مین نیٹ پر ETH بھیجیں۔",
    "donate.qrAlt": "{coin} عطیہ ایڈریس کا QR کوڈ",
