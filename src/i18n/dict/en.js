...
export const DICTIONARY = {
    ...
    "theme.light": "Light",
    "theme.dark": "Dark",
    "donate.eyebrow": "Donate in crypto",
    "donate.title": "Keep SecureBit independent",
    "donate.description": "Every donation goes to development and audits.",
    "donate.copy": "Copy",
    "donate.copied": "Copied",
    "donate.net.usdt": "USDT · Tron (TRC-20)",
    "donate.net.btc": "Bitcoin network",
    "donate.net.eth": "Ethereum mainnet",
    "donate.warn.usdt": "Send only USDT on Tron (TRC-20).",
    "donate.warn.btc": "Send only BTC on the Bitcoin network.",
    "donate.warn.eth": "Send only ETH on Ethereum mainnet.",
    "donate.qrAlt": "QR code of the {coin} donation address",
