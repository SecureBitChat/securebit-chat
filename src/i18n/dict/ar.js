...
export const DICTIONARY = {
    ...
    "theme.light": "فاتح",
    "theme.dark": "داكن",
    "donate.eyebrow": "تبرّع بالعملات المشفّرة",
    "donate.title": "ساعدنا في إبقاء SecureBit مستقلًا",
    "donate.description": "يذهب كل تبرّع إلى التطوير وعمليات التدقيق الأمني.",
    "donate.copy": "نسخ",
    "donate.copied": "تم النسخ",
    "donate.net.usdt": "USDT · Tron (TRC-20)",
    "donate.net.btc": "شبكة Bitcoin",
    "donate.net.eth": "الشبكة الرئيسية لـ Ethereum",
    "donate.warn.usdt": "أرسل USDT على شبكة Tron (TRC-20) فقط.",
    "donate.warn.btc": "أرسل BTC على شبكة Bitcoin فقط.",
    "donate.warn.eth": "أرسل ETH على الشبكة الرئيسية لـ Ethereum فقط.",
    "donate.qrAlt": "رمز QR لعنوان التبرّع بـ {coin}",
