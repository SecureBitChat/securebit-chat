...
export const DICTIONARY = {
    ...
    "theme.light": "בהיר",
    "theme.dark": "כהה",
    "donate.eyebrow": "תרומה בקריפטו",
    "donate.title": "עזרו לשמור על SecureBit עצמאית",
    "donate.description": "כל תרומה מופנית לפיתוח ולביקורות אבטחה.",
    "donate.copy": "העתקה",
    "donate.copied": "הועתק",
    "donate.net.usdt": "USDT · Tron (TRC-20)",
    "donate.net.btc": "רשת Bitcoin",
    "donate.net.eth": "הרשת הראשית של Ethereum",
    "donate.warn.usdt": "שלחו USDT ברשת Tron (TRC-20) בלבד.",
    "donate.warn.btc": "שלחו BTC ברשת Bitcoin בלבד.",
    "donate.warn.eth": "שלחו ETH ברשת הראשית של Ethereum בלבד.",
    "donate.qrAlt": "קוד QR של כתובת התרומה ב-{coin}",
