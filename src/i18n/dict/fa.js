...
export const DICTIONARY = {
    ...
    "theme.light": "روشن",
    "theme.dark": "تیره",
    "donate.eyebrow": "اهدای کمک با رمزارز",
    "donate.title": "به مستقل ماندن SecureBit کمک کنید",
    "donate.description": "هر کمک صرف توسعه و ممیزی‌های امنیتی می‌شود.",
    "donate.copy": "کپی",
    "donate.copied": "کپی شد",
    "donate.net.usdt": "USDT · Tron (TRC-20)",
    "donate.net.btc": "شبکه Bitcoin",
    "donate.net.eth": "شبکه اصلی Ethereum",
    "donate.warn.usdt": "فقط USDT را روی شبکه Tron (TRC-20) بفرستید.",
    "donate.warn.btc": "فقط BTC را روی شبکه Bitcoin بفرستید.",
    "donate.warn.eth": "فقط ETH را روی شبکه اصلی Ethereum بفرستید.",
    "donate.qrAlt": "کد QR نشانی کمک با {coin}",
